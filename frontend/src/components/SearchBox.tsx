      ...
      <div className="flex gap-4">
        <div className="flex-1">
          <input
            ...
            className="w-full px-4 py-3 text-lg border-2 border-gray-300 rounded-2xl focus-within:ring-2 ring-indigo-500 focus:border-indigo-500 focus:outline-none transition-all duration-200 text-gray-900 shadow-md hover:shadow-lg"
            disabled={loading}
          />
        </div>
        <button
